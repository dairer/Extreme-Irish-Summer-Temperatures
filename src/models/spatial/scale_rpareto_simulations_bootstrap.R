...
scale_bts_sim = function(bts_range, marg_mod, yr, num_quantiles, tmp){
  ...
  # # --- find out which bootstraps have been scaled already
  # data_sets = list.files('output/simulations/rescaled_simulations_on_obs_grid/bootstraps/')
  ...
  #   unique %>% 
  #   as.numeric()
  # bts_range = bts_range[!(bts_range%in%bts_ran)]
  # 
...
this_temp_to_scale_upto = 35
# this_temp_to_scale_upto = 28
#is_temp_to_scale_upto = 29
#this_temp_to_scale_upto = 30
#this_temp_to_scale_upto = 31
#this_temp_to_scale_upto = 35

# this_temp_to_scale_upto = 33
# this_temp_to_scale_upto = 34


# job::job({scale_bts_sim(bts_range = seq(1, 200), "mod_4", 1942,25, this_temp_to_scale_upto)})
# job::job({scale_bts_sim(bts_range = seq(201,400), "mod_4", 1942,25, this_temp_to_scale_upto)})
# job::job({scale_bts_sim(bts_range = seq(401,500), "mod_4", 1942,25, this_temp_to_scale_upto)})
# job::job({scale_bts_sim(bts_range = seq(1,200), "mod_4", 2020, 25, this_temp_to_scale_upto)})
# job::job({scale_bts_sim(bts_range = seq(201,400), "mod_4", 2020,25, this_temp_to_scale_upto)})
# job::job({scale_bts_sim(bts_range = seq(401,500), "mod_4", 2020,25, this_temp_to_scale_upto)})


job::job({scale_bts_sim(bts_range = seq(301,400), "mod_1", 1942, 15, this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(401,500), "mod_1", 1942, 15,  this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(301,400), "mod_1", 2020, 15, this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(401,500), "mod_1", 2020, 15, this_temp_to_scale_upto)})

job::job({scale_bts_sim(bts_range = seq(301,400), "mod_2", 1942, 15, this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(401,500), "mod_2", 1942, 15,  this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(301,400), "mod_2", 2020, 15, this_temp_to_scale_upto)})
job::job({scale_bts_sim(bts_range = seq(401,500), "mod_2", 2020, 15, this_temp_to_scale_upto)})
