...
Stations_meta = read_csv("~/Inference for extreme spatial temperature events in a changing climate with application to Ireland/data/raw/obs/met_eireann_meta.csv") %>%
...
all_data %>% write_csv("~/Inference for extreme spatial temperature events in a changing climate with application to Ireland/data/processed/met_eireann_data.csv")
